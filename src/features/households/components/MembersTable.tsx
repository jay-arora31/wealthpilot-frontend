        ...
        <Table className="min-w-[620px]">
          <TableHeader>
            <TableRow className="bg-muted/30 hover:bg-muted/30">
              <TableHead className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider pl-4 sm:pl-6 h-11">Name</TableHead>
            ...
            {members.map((m) => {
              ...
              return (
                <TableRow key={m.id} className="odd:bg-white even:bg-muted/20 hover:bg-primary/4 transition-colors group">
                  <TableCell className="font-semibold text-[13px] pl-4 sm:pl-6 py-3.5">{m.name}</TableCell>
